...
# Create new column for playerName edits
...
for(i in 1:nrow(nba_tbl)){
  ...
  nba_tbl[i, "fn3ltr"] <- str_sub(as.character(namePlayerCol), end = 3)
...
nba_college_tbl <- left_join(nba_by_year_team, yr_college_tbl, by = c("namePlayerCol" = "Player"))
