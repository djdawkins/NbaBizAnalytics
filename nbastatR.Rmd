...
# Group by player
yr_team_gb <- group_by(full_tbl, year, Team)
# Summarise AV mean, include groupPosition and year columns as-is
...
yr_team_tbl <- yr_team_tbl %>% filter(Team !="Butler")
...
# get_schedule <- function(year, team){
for(i in 1:nrow(yr_team_tbl)){
  ...
  # print(class(team %>% getElement("Team")))
  # print(year)
  # Get schedule data
...
team = "Butler"
schedule <- get_team_schedule(season = "2009-10", team.name = team)
